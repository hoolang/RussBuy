...
import com.hoolang.dao.base.CommentsDao;
import com.hoolang.dao.base.LikeDao;
import com.hoolang.dao.base.PostDao;
...
import com.hoolang.service.PostService;
...
//        	System.out.println(post.getUser().getIcon());
        	...
        	// 重新设置show图片的绝对路径
        	post.setPhoto(Hoolang.SHOW_PHOTO_URL + post.getPhoto());
