...
//            {
                ...
                exifDirectory.add(ExifTagConstants.EXIF_TAG_OWNER_NAME, "Hoolang");
...
//            }
	...
	public static void main(String[] args) throws ImageReadException, ImageWriteException, IOException {
		HLExifRewriter exif = new HLExifRewriter();
		File file = new File("/Users/hoolang/build/");//561cc758627ec95e0297f43a-1-original.jpg
		//exif.setExifGPSTag(new File(file, "561cc758627ec95e0297f43a-1-original.jpg"), new File(file,"change.jpg"));
		exif.changeExifMetadata(new File(file, "561cc758627ec95e0297f43a-1-original.jpg"), new File(file,"561cc758627ec95e0297f43a-2-original.jpg"));
	}
